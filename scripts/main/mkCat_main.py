...
parser.add_argument("--absmagmd", help="whether to use purely photometry+z based rest frame info or fastspecfit, or no k correction at all",choices=['spec','phot','nok', 'SDSSCORR_LOGMSTAR'],default='spec')
